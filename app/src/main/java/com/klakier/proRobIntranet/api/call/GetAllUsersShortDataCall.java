...
public class GetAllUsersShortDataCall implements ApiCall {

    Context mContext;
    Token mToken;
    Call<UserDataShortResponse> mCall;

    public GetAllUsersShortDataCall(Context context, Token token) {
        ...
        mCall = RetrofitClient
                .getInstance()
                .getApi()
                .getAllUsersShort("Bearer " + mToken.getToken());
    }
